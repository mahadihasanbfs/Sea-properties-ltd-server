...
const { add_blog,
    ...
    get_blog_by_id,
    delete_blog,
    get_all_blogs } = require('../Modules/Admin/Blog');

const { add_project,
    update_project,
    get_all_projects,
    get_project_by_id,
    delete_project } = require('../Modules/Admin/Porject');

const { add_installment,
    update_installment,
    get_all_installments,
    get_installment_by_id,
    delete_installment } = require('../Modules/Admin/Installment');

const { get_all_newsletters,
    delete_newsletter_by_id,
    create_newsletter } = require('../Modules/Admin/news_letter');

const { add_booking,
    delete_booking,
    get_booking_by_id,
    get_all_bookings,
    update_booking } = require('../Modules/Admin/Booking');
